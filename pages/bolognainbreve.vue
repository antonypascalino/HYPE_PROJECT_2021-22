  ...
  <main class="page-container">
    <div class="body-container">
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6" >
            <p>Città d’arte, cultura e commercio con un'efficiente struttura fieristica e una rinomata tradizione manifatturiera e motoristica, Bologna è nota per i quasi 40 km di portici, i più lunghi del mondo.
              ...
              Passeggiate sotto il portico più lungo del mondo (<b>666 arcate!</b>) fino alla Basilica di San Luca. È una passeggiata un po’ faticosa, ma una volta in cima vi offrirà dei panorami mozzafiato.</p>
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-2 col-md-6" >
              <p>Bologna è sinonimo di enogastronomia. <b>Mortadella, "ragù alla Bolognese", tortellini, lasagne, tagliatelle, bollito, certosino</b>, sono solo alcuni dei prodotti che l’hanno resa famosa nel mondo insieme alle mitiche sfogline, i cui corsi di cucina sono frequentati da visitatori di ogni continente. Altrettanto noti sono i <b>Vini DOC </b> dei Colli Bolognesi, fra i quali il tipico Pignoletto.
                ...
                La leggenda racconta che i tortellini siano stati modellati sulla forma dall'ombelico di Venere. Le tagliatelle, sempre secondo la leggenda, furono create a imitazione dei lunghi capelli biondi di Lucrezia Borgia in occasione delle sue nozze con il Duca di Ferrara, Alfonso I d'Este.</p>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-2 col-md-6" >
              <p>La città pulsa di vita di giorno e di notte nelle <b>numerose osterie, teatri, gallerie, librerie, piazze e negozi</b>. Nelle suggestive stradine adiacenti Piazza Maggiore, dove si snoda tra botteghe di prodotti tipici il vivace e pittoresco mercato del Quadrilatero, i più golosi non possono rinunciare ad una sosta nel più antico e rinomato laboratorio di cioccolato della città e all’aperitivo in un'antica enoteca.
                ...
                La città ospita inoltre numerosi locali notturni e discoteche dove ascoltare la migliore musica dal vivo. <b>Dal clubbing, al rock, al jazz,</b> un interessante mix di stili che decreta Bologna aperta alla novità anche in fatto di ritmo e sonorità. La città vive la notte anche con un semplice ritrovo in piazza, dove tantissimi giovani si danno appuntamento per restare con gli amici, con una chitarra e qualche bottiglia di birra.
                Dal quartiere studentesco al cuore di piazza Maggiore, il divertimento vive indisturbato animando la notte, verrebbe da chiamarla “la goiosa”, oltre che “la grassa e la dotta”, perché l’allegria e la condivisione sono una caratteristica di questa città a tutte le ore del giorno.</p>
      ...
      <section class="section-la-nostra-missione">
       ...
       <p>Bologna è ancora una città a misura d’uomo e, almeno nella zona del centro storico, le distanze si coprono a piedi in poco tempo. Arrivati in città, è consigliabile lasciare la macchina in uno dei numerosi parcheggi perché il centro è Zona a Traffico Limitato.
         Il modo migliore per visitare Bologna è sicuramente a <b>piedi o in bici</b>, anche per via delle ZTL e delle aree pedonali. Il centro è abbastanza raccolto, ma le attrazioni da visitare sono tante, e alcune dislocate anche appena fuori dal centro. Per questo, per un primo approccio alla città vi consigliamo di fare prima un tour guidato a piedi, per individuare i punti di riferimento e conoscere meglio la città.
         Come accennato, un'alternativa green è la <b>bici</b> : il suolo pianeggiante della città e le aree pedonali o ztl sono un ottimo incentivo per una pedalata all'aria aperta e all'insegna della scoperta.
         <b>Per una panoramica rapida, c'è il sempreverde bus turistico scoperto.</b></p>
         </section>
    </div>
