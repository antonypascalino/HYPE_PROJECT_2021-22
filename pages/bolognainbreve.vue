    ...
    <div class="body-container">
      ...
      <section class="section-la-nostra-missione">
       ...
       <p>Bologna è ancora una città a misura d’uomo e, almeno nella zona del centro storico, le distanze si coprono a piedi in poco tempo. Arrivati in città, è consigliabile lasciare la macchina in uno dei numerosi parcheggi perché il centro è Zona a Traffico Limitato.
         Il modo migliore per visitare Bologna è sicuramente a <b>piedi o in bici</b>, anche per via delle ZTL e delle aree pedonali. Il centro è abbastanza raccolto, ma le attrazioni da visitare sono tante, e alcune dislocate anche appena fuori dal centro. Per questo, per un primo approccio alla città vi consigliamo di fare prima un tour guidato a piedi, per individuare i punti di riferimento e conoscere meglio la città.</p>
         </section>
    </div>
