    ...
    <div class="body-container">
      ...
      <section class="section-common section-start">
        <p class="bologna-paragraph end-paragraph">
          <span style="font-weight: bold; color: #c13939; font-style: italic"
            >Capoluogo</span
          >
          della Città metropolitana e della regione Emilia-Romagna, Bologna è
          situata tra le montagne dell'Appennino tosco-emiliano ed il cuore
          della <b>Pianura Padana</b>.
        </p>
        <p class="bologna-paragraph end-paragraph">
        ...
        <p class="bologna-paragraph end-paragraph">
          La città, i cui primi insediamenti risalirebbero almeno al I millennio
          a.C., fu un importante centro urbano dapprima sotto gli Etruschi e i
          Celti, poi sotto i Romani e, nel Medioevo, come libero comune.
            ...
            <div class="col-xl-6 col-lg-8 col-md-6">
              <p class="bologna-paragraph">
                <span
                  ...
                  "
                >
                  "Città d’arte, cultura e commercio"</span
                >
              </p>
              <p class="bologna-paragraph">
                con un'efficiente struttura fieristica e una rinomata tradizione
                manifatturiera e motoristica, Bologna è nota per i quasi 40 km
                di portici, i più lunghi del mondo. Chiamata anche la
                <b>“Dotta”</b>, per via della sua antica Università, e la
                “Grassa” per la sua gastronomia, la città si fregia del titolo
                "Città creativa della Musica UNESCO" e vanta un centro storico
                medievale tra i più estesi e meglio conservati d’Europa,
            ...
            <div class="col-xl-6 col-lg-8 col-md-6">
              <p class="bologna-paragraph">
                <span
                  ...
                  "
                >
                  "Mortadella, ragù, tortellini, lasagne e tagliatelle"</span
                >
              </p>
              <p class="bologna-paragraph">
            ...
            <div class="col-xl-6 col-lg-8 col-md-6">
              <p class="bologna-paragraph">
                <span
                  ...
                  "
                >
                  "La città pulsa di vita di giorno e di notte"</span
                >
              </p>
              <p class="bologna-paragraph">
      ...
      <section class="section-common section-End">
        ...
        <p class="bologna-paragraph end-paragraph">
          ...
          parcheggi perché il centro è Zona a Traffico Limitato. Il modo
          migliore per visitare Bologna è sicuramente a <b>piedi o in bici</b>,
          anche per via delle ZTL e delle aree pedonali. Il centro è abbastanza
          raccolto, ma le attrazioni da visitare sono tante, e alcune dislocate
          anche appena fuori dal centro. Per questo, per un primo approccio alla
          città vi consigliamo di fare prima un tour guidato a piedi, per
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            'This page describes the history and the culture of Bologna. ',
        },
      ],
    }
  },
