      ...
      >
        ...
        >
          <div class="imageContainer">
            <nuxt-link :to="`/servizi/${poi.id}`">
              <img class= "carouselImg" :src="require(`@/static/Services/${poi.imgBackground}`)" :alt="poi.name">
            </nuxt-link>
      ...
      <div class="carouselScroll"
        ...
        <div class="imageContainer container-scroll">
          <nuxt-link :to="`/pois/${poi.id}`">
            <img class= "carouselImg image-scroll" :src="require(`@/static/Services/${poi.imgBackground}`)" :alt="poi.name">
          </nuxt-link>
